...
- Context-aware, configurable snippets
...
The integration with quickproject is pretty simple and lets you
...
values from breeze's configuration, but lets you change them. All
...
with some pre-configured content (template) and lets you code right
