...
*  Why include e-graphs in breeze?
:PROPERTIES:
:ID:       738d1d1b-ef4b-4313-925e-e6e63a4f9fb7
:END:

Because I want to provide an interactive refactoring tool that can
search for equivalent implementation of a piece of code.
