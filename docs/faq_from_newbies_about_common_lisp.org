...
#+begin_quote
This page contains some common questions about common lisp. This is
useful for guiding breeze's development, to figure out the pain
points.
#+end_quote

Ideally, this should go somewhere else, like in tutorial, a cookbook
or some kind of reference (like [[https://github.com/fstamour/lisp-docs.github.io][lisp-docs.github.io]]).
