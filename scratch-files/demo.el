...
(defun breeze/demo/next-to-this-file (filename)
  (expand-file-name
   (concat (file-name-directory breeze/breeze.el)
	   "../scratch-files/"
	   filename)))

;; (breeze/demo/next-to-this-file "demo.html")
;; => ".../breeze/scratch-files/demo.html"
