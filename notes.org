...
** TODO [#A] Reader doesn't support local package nicknames
...
** TODO trying to find disprecancies between the packages and test packages

or betwee test system and the system under test
